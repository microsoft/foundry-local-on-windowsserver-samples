...
async function getAlertsForState(state) {
...
async function getForecastForLocation(latitude, longitude) {
...
function getServer() {
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        switch (name) {
            case "get_alerts":
                const alertsResult = await getAlertsForState(args.state);
                return {
                    content: [{
                            type: "text",
                            text: alertsResult
            ...
            case "get_forecast":
                const forecastResult = await getForecastForLocation(args.latitude, args.longitude);
                return {
                    content: [{
                            type: "text",
                            text: forecastResult
